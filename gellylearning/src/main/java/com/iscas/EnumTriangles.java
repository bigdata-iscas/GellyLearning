...
import com.iscas.data.EnumTrianglesData;
import com.iscas.utils.EnumTrianglesDataTypes;
...
public class EnumTriangles {
	...
	public static void main(String[] args) throws Exception {
		...
		DataSet<EnumTrianglesDataTypes.Triad> triangles = edgesById
				...
				// filter triads
				.join(edgesById).where(EnumTrianglesDataTypes.Triad.V2, EnumTrianglesDataTypes.Triad.V3).equalTo(EnumTrianglesDataTypes.Edge.V1, EnumTrianglesDataTypes.Edge.V2).with((FlatJoinFunction<EnumTrianglesDataTypes.Triad, EnumTrianglesDataTypes.Edge, EnumTrianglesDataTypes.Triad>) new TriadFilter());
